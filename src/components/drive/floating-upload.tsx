...
export default function FloatingUpload({ folderId }: { folderId: number }) {
  ...
  return (
    <Popover>
      <Container className="fixed bottom-0 w-full">
        <PopoverTrigger className="absolute right-4 bottom-4">
        ...
        <PopoverContent
          sideOffset={8}
          align="end"
          className="flex flex-col rounded-xl border-none bg-neutral-700 p-1.5 text-white"
        >
          {mode === "folder" ? (
